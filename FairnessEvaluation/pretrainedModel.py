...
for region in tqdm(regions):
    for cv_i in range(30):
        ...
        other_region_train = train.loc[train_filter[region_category] != region]
        other_region_train_target = train_target.loc[train_filter[region_category] != region]
        other_region_train_supplement = train_supplement.loc[train_filter[region_category] != region]
        other_region_train_filter = train_filter.loc[train_filter[region_category] != region]
        ...
        clf.fit(other_region_train, other_region_train_target["tg-default"])
        ...
        #clf = XGBClassifier(device="cuda", n_estimators= 500)
        #clf.fit(other_region_train, other_region_train_target["tg-int_rate_cat"])
        ...
        reg.fit(other_region_train, other_region_train_target["tg-int_rate"])
...
results.to_excel("./results/sub/pretrainedModel.xlsx", index=False)