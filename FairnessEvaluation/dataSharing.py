...
for region in tqdm(regions):
    for cv_i in range(30):
        ...
        share_region = random.choice(list(set(regions) - set(region)))
        share_region_train = train.loc[train_filter[region_category] == share_region]
        share_region_train_target = train_target.loc[train_filter[region_category] == share_region]
        share_region_test = test.loc[test_filter[region_category] == share_region]
        share_region_test_target = test_target.loc[test_filter[region_category] == share_region]
